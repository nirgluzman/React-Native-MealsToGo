//
// Mock location data, representing data as it would be received from the Google Location Service.
//
...
export type LocationMockKeys = keyof typeof locations;
export type LocationMockData = (typeof locations)[LocationMockKeys];
