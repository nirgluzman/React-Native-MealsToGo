...
export type MockKeys = keyof typeof mocks;
export type MockData = (typeof mocks)[MockKeys];
...
export type MockImageKeys = keyof typeof mockImages;
export type MockImageData = (typeof mockImages)[MockImageKeys];
